            ...
            <div className="container-lg container-md d-flex flex-column justify-content-start bg-white container vw-100 vh-100">
                ...
                <div className="container-lg h-100">
                    ...
                    <div className="container-lg fw__bold">
                        <div style={{ backgroundColor: '#FAFAFA' }} className="row align-items-center border rounded shadow mb-5">
                            ...
                            <div className="col-2 ps-0"><FiXCircle cursor='pointer' size='2rem' color='#F20000' /></div>
                        </div>
                    </div>
